...
plot.savefig('addClientNsPerOp.svg')
plot.show()
...
plot.savefig('addClientAllocsPerOp.svg')
plot.show()
...
plot.savefig('addClientAllocedBytesPerOp.svg')
plot.show()
...
plot.savefig('getClientNsPerOp.svg')
plot.show()
...
plot.savefig('getClientAllocsPerOp.svg')
plot.show()
...
plot.savefig('getClientAllocedBytesPerOp.svg')
plot.show()
